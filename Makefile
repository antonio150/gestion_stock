...
first-install: docker-up docker-php-ext-install mysqli pdo pdo_mysql intl composer-install npm-install npm-build sf-perm sf-dc sf-dmm sf-start sf-open ## First install.
.PHONY: first-install
